...
let stick = 0;
//
// function divMaker(tagName, setAttributeName, setAttributeValue, parent) {
//   const elemet = document.createElement(tagName);
//   elemet.setAttribute(setAttributeName, setAttributeValue);
//   parent.appendChild(elemet);
// };
// divMaker('div', 'style', '', root);
//
